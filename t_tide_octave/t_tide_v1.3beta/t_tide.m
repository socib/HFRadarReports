...
%              29/9/14 -numerical typo in MAD to STD conversion corrected!
%
% Version 1.3
...
[Pxr,fx]=pwelch(real(xres),hanning(nx),[],nx,1/dt); % Call to SIGNAL PROCESSING TOOLBOX - see note in t_readme. If you have an error here you are probably missing this toolbox
Pxr=Pxr/2/dt;
[Pxi,fx]=pwelch(imag(xres),hanning(nx),[],nx,1/dt); % Call to SIGNAL PROCESSING TOOLBOX - see note in t_readme.
Pxi=Pxi/2/dt;
